...
const navItems = [
  ...
  { to: '/logs', label: 'System Logs', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ...
        >
          ...
          <div className="flex flex-1 items-center">
            <img
              src="/logo.png"
              alt="Tradeict HFT"
              className="h-8 max-h-8 w-auto object-contain md:h-[40px] md:max-h-[40px]"
            />
          </div>
